...
run-monitoring: ## Run retrieval evaluation and write monitoring/data/retrieval_evaluation.json (requires existing index)
	@uv run python -m periscope.run_monitoring
